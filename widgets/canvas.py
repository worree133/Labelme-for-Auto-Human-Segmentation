...
class Canvas(QtWidgets.QWidget):
    ...
    def mouseMoveEvent(self, ev):
        ...
        if self.drawing():
            ...
            if self.createMode in ["polygon","linestrip"]:
                ...
                if ev.buttons() and QtCore.Qt.LeftButton and self.draw:
                    painter = QtGui.QPainter(self.m_pixmap)
                    painter.setPen(QtGui.QPen(QtCore.Qt.gray, 30, QtCore.Qt.SolidLine))
                    painter.drawLine(self.lastPoint, ev.pos())
    ...
    def mousePressEvent(self, ev):
        ...
        if ev.button() == QtCore.Qt.LeftButton:
            if self.drawing():
                ...
                self.prevPoint = pos
                self.repaint()
        elif ev.button() == QtCore.Qt.RightButton and self.createMode == "line":
            self.fill(ev.pos())
    ...
    def correctShapes(self,correctedpoints):
        ...
        if b>a:
            ...
            if (a-b) > (c-a+b):
                ...
                nshape.reverse()
                nshape = orishape[:b] + nshape + orishape[a + 2:]
    ...
    def Checks(self):
        ...
        rect, groupid, modeltype, matting = findcorrespondingrect(self.filename, x1, y1, x2, y2)
        ...
        if modeltype == 'vitae':
            ...
            self.tunesave = matting[int(y1):int(y2), int(x1):int(x2)]
